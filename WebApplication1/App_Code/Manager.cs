...
namespace UCMOHealthCare
{
    ...
    {
        string ManagerID, Lname, Fname, Address, Email, Phone;
        public Manager(string Mid)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("select lastname,firstname,address,email,phone from manager_details where mid =@username ", con);
            cmd.Parameters.AddWithValue("@username", ManagerID);
