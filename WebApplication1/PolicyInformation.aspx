<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PolicyInformation.aspx.cs" MasterPageFile="UCMO.Master" Inherits="UCMOHealthCare.PolicyInformation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" 
            BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellPadding="3" CellSpacing="1" DataKeyNames="PolicyID" DataSourceID="SqlDataSource1" 
            GridLines="Both">
            <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HISConnectionString %>" SelectCommand="SELECT [PolicyID], [PolicyDescription], [Price], [NumOfMembers] FROM [policy_details]"></asp:SqlDataSource>
    </p>
</asp:Content>
