...
public partial class responseToGuestQuotes : System.Web.UI.Page
{
    int row = 0;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("select * from guest_quote_requests where req_status=@status", con);
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            SqlConnection con = new SqlConnection(connectionString);
            con.Open();
            SqlCommand cmd = new SqlCommand("update guest_quote_requests set respone_by=@username,response=@resp,req_status=@setOld where id=@rowid", con);
